...
public class UnstoringDetailDTO {
    ...
    // Delete용 생성자
    public UnstoringDetailDTO(String ex_no, String item_cd, String qty) {
        this.ex_no = ex_no;
    ...
    // Insert용 생성자
    public UnstoringDetailDTO(String corp_cd, String ex_no, String item_cd, String qty, String stor_cd, String loca_cd, String emp_no) {
