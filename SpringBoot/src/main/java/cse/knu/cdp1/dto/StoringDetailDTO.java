...
public class StoringDetailDTO {
    ...
    // Delete용 생성자
    public StoringDetailDTO(String purc_in_no, String item_cd, Double qty) {
    ...
    // Insert용 생성자
    public StoringDetailDTO(String corp_cd, String purc_in_no, String item_cd, Double qty, String stor_cd, String loca_cd, String emp_no) {
