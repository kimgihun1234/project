...
class FragmentInState : Fragment() {
    ...
    private var data : List<InReturnStateRecyclerAdapter> = kotlin.collections.emptyList()
...
//                    )
    ...
    fun getInstance(customerNumString : String, startDate : String, endDate : String, itemNumstring: String){
        ...
        val url = "http://101.101.208.223:8080/storingList"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                if (response.isSuccessful) {
                    ...
                    val data = Gson().fromJson(myRequest, Array<StoringListGetData>::class.java).toList()
                    ...
                    activity!!.runOnUiThread{
                        ...
                        val inStateRecyclerView = InStateRecyclerAdapter(data)

                        recyclerView.apply {
                            layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
                            adapter = inStateRecyclerView
                        }
                    }
                }
            }
