...
class NumRecyclerAdapter() : RecyclerView.Adapter<NumRecyclerAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NumRecyclerAdapter.MyViewHolder {
    ...
    override fun onBindViewHolder(holder: NumRecyclerAdapter.MyViewHolder, position: Int) { //xml과 data 연결
