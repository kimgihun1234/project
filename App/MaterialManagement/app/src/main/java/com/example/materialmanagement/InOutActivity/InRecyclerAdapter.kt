...
import com.example.materialmanagement.DTO.InPostInfo
import com.example.materialmanagement.DTO.StoreStateInfo
import com.example.materialmanagement.R
import java.text.SimpleDateFormat
import java.util.*

class InRecyclerAdapter(private var myRequest: List<StoreStateInfo>) : RecyclerView.Adapter<InRecyclerAdapter.MyViewHolder>() {
