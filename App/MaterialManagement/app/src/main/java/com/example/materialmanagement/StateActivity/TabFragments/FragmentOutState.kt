...
import com.example.materialmanagement.DTO.UnstoringListGetData
...
//                    )
    ...
    fun getInstance(customerNumString : String, startDate : String, endDate : String, itemNumstring: String){
        ...
        val url = "http://101.101.208.223:8080/unstoringList"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                if (response.isSuccessful) {
                    ...
                    val data = Gson().fromJson(myRequest, Array<UnstoringListGetData>::class.java).toList()
                    ...
                    activity!!.runOnUiThread{
                        ...
                        val outStateRecyclerView = OutStateRecyclerAdapter(data)

                        recyclerView.apply {
                            layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
                            adapter = outStateRecyclerView
                        }
                    }
                }
            }
